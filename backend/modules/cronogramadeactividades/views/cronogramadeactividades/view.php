...
<div class="cronogramadeactividades-view">
    ...
    <h1><?= Html::encode($this->title) ?></h1>
     <p>
        ...
        <?= Html::a('Volver', ['verificar', 'id' => $model->proyectosinternos_id ], ['class' => 'btn btn-success']) ?>
    </p>

    <p>
        <?= Html::a('Actualizar', ['update', 'id' => $model->idcronogramadeactividades], ['class' => 'btn btn-primary']) ?>
